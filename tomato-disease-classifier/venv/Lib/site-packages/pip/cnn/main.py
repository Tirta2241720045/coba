...
from dataset_preparation import create_dataset
from image_preprocessing import increase_brightness, filter_colors
from model_architecture import create_model
from training_visualization import plot_training_history


def main():
    data_dir = "F:/pip/dataset"  # Path ke dataset lokal
